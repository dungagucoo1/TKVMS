...
// After reset
    ...
    reset = 0;
    #2;
    in_e1 = 64'h d658a36b11cf46eb; in_d1 = 64'h e0fca820fb3d9b0b;
    in_e2 = 64'h d658a36b11cf46eb; in_d2 = 64'h e0fca820fb3d9b0b;
    load_data = 1;
    #2;
    load_data = 0;
    #66;
...
// Reset in processing
    #2;
    in_e1 = 64'h e0fca820fb3d9b0b; in_d1 = 64'h f9644ed22b21c5d7;
    in_e2 = 64'h e0fca820fb3d9b0b; in_d2 = 64'h f9644ed22b21c5d7;
    load_data = 1;
    #2;
    load_data = 0;
    #12;
    ...
    reset = 0;
    #2;
    in_e1 = 64'h f9644ed22b21c5d7; in_d1 = 64'h 583dee85ce821054;
    in_e2 = 64'h f9644ed22b21c5d7; in_d2 = 64'h 583dee85ce821054;
    load_data = 1;
    #2;
    load_data = 0;
    #66;
...
// Start with reset
    #2;
    in_e1 = 64'h 583dee85ce821054; in_d1 = 64'h 3b5834a000fba066;
    in_e2 = 64'h 583dee85ce821054; in_d2 = 64'h 3b5834a000fba066;
    load_data = 1;
    reset = 1;
    #2;
    load_data = 0;
