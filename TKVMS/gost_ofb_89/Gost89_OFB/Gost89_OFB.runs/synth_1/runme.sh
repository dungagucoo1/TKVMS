...
HD_PWD='D:/Vivado/Bao cao/TKVMS/Gost89_OFB/Gost89_OFB.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gost89_ofb_encrypt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gost89_ofb_encrypt.tcl
