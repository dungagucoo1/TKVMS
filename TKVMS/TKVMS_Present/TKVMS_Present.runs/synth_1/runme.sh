...
HD_PWD='D:/Vivado/VHDL ver2020.2/TKVMS_Present/TKVMS_Present.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PRESENT_DECRYPT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PRESENT_DECRYPT.tcl
