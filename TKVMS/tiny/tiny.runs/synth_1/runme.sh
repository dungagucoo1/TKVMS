...
HD_PWD='D:/Vivado/Bao cao/TKVMS/TKVMS/tiny/tiny.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TEA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TEA.tcl
